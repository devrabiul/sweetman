                    ...
                    <div class="pt-6 px-4" x-show="open" style="display: none;">
                        <div class="space-y-4">
                            ...
                            <div class="rounded-md shadow-sm -space-y-px">
                                <div>
                                    <input type="integer" wire:model.defer="min_price" minlength="1" min="1" maxlength="999999999" max="999999999" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 dark:placeholder-gray-200 dark:text-gray-100 text-gray-900 rounded-t-md focus:outline-none focus:ring-primary-600 focus:border-primary-600 focus:z-10 sm:text-sm font-medium black:bg-transparent dark:border-zinc-600" placeholder="{{ __('messages.t_min_price') }}">
                                </div>
                                <div>
