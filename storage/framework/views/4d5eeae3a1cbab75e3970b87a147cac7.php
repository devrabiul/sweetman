...
} elseif ($_instance->childHasBeenRendered('i6M7fwE')) {
    $componentId = $_instance->getRenderedChildComponentId('i6M7fwE');
    $componentTag = $_instance->getRenderedChildComponentTagName('i6M7fwE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('i6M7fwE');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('i6M7fwE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('3v6uCbh')) {
    $componentId = $_instance->getRenderedChildComponentId('3v6uCbh');
    $componentTag = $_instance->getRenderedChildComponentTagName('3v6uCbh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3v6uCbh');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('3v6uCbh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>