<div class="w-full" x-data="window.AxZSIHcEeIYErvQ" x-init="initialize()" @keydown.window.escape="open = false" x-cloak>
    ...
    <div x-show="open" class="fixed inset-0 flex z-40 lg:hidden" x-ref="dialog" aria-modal="true">
        ...
        <div x-show="open" x-transition:enter="transition ease-in-out duration-300 transform" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in-out duration-300 transform" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full" class="ml-auto relative max-w-xs w-full h-full bg-white dark:bg-zinc-800 shadow-xl py-4 pb-12 flex flex-col overflow-y-auto" style="display: none;">
            ...
            <div class="mt-4 border-t border-grey-200 dark:border-zinc-700">
                    ...
                    <div class="pt-6 px-4" x-show="open" style="display: none;">
                        <div class="space-y-4">
                            ...
                            <div class="rounded-md shadow-sm -space-y-px">
                                <div>
                                    <input type="integer" wire:model.defer="min_price" minlength="1" min="1" maxlength="999999999" max="999999999" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 dark:placeholder-gray-200 dark:text-gray-100 text-gray-900 rounded-t-md focus:outline-none focus:ring-primary-600 focus:border-primary-600 focus:z-10 sm:text-sm font-medium black:bg-transparent dark:border-zinc-600" placeholder="<?php echo e(__('messages.t_min_price')); ?>">
                                </div>
                                <div>
                    ...
                    <div x-data="Components.menu({ open: false })" x-init="init()" @keydown.escape.stop="open = false; focusButton()" @click.away="onClickAway($event)" class="relative inline-block ltr:text-left rtl:text-right">
                        ...
                        <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="ltr:origin-top-right rtl:origin-top-left absolute ltr:right-0 rtl:left-0 mt-2 w-40 rounded-md shadow-sm bg-white dark:bg-zinc-800 ring-1 ring-black ring-opacity-5 focus:outline-none z-50" x-ref="menu-items" x-bind:aria-activedescendant="activeDescendant" role="menu" aria-orientation="vertical" tabindex="-1" @keydown.arrow-up.prevent="onArrowUp()" @keydown.arrow-down.prevent="onArrowDown()" @keydown.tab="open = false" @keydown.enter.prevent="open = false; focusButton()" @keyup.space.prevent="open = false; focusButton()" style="display: none;">
                            <div class="py-1" role="none">
                                ...
                                <button wire:click="setSortBy('popular')" type="button" class="<?php echo e($sort_by === 'popular' ? 'text-gray-900' : 'text-gray-500'); ?> block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    <?php echo e(__('messages.t_most_popular')); ?>

                                </button>

                                
                                <button wire:click="setSortBy('rating')" type="button" class="<?php echo e($sort_by === 'rating' ? 'text-gray-900' : 'text-gray-500'); ?> block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    <?php echo e(__('messages.t_best_rating')); ?>

                                </button>

                                
                                <button wire:click="setSortBy('sales')" type="button" class="<?php echo e($sort_by === 'sales' ? 'text-gray-900' : 'text-gray-500'); ?> block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    <?php echo e(__('messages.t_most_selling')); ?>

                                </button>

                                
                                <button wire:click="setSortBy('newest')" type="button" class="<?php echo e($sort_by === 'newest' ? 'text-gray-900' : 'text-gray-500'); ?> block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    <?php echo e(__('messages.t_newest_first')); ?>

                                </button>

                                
                                <button wire:click="setSortBy('price_low_high')" type="button" class="<?php echo e($sort_by === 'price_low_high' ? 'text-gray-900' : 'text-gray-500'); ?> block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
                                    <?php echo e(__('messages.t_price_low_to_high')); ?>

                                </button>

                                
                                <button wire:click="setSortBy('price_high_low')" type="button" class="<?php echo e($sort_by === 'price_high_low' ? 'text-gray-900' : 'text-gray-500'); ?> block px-4 py-3 text-xs font-medium hover:bg-gray-100 dark:hover:bg-zinc-700 dark:text-gray-400 w-full ltr:text-left rtl:text-right">
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script src="<?php echo e(getDynamicAsset('public/js/components.js')); ?>"></script>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/categories/category.blade.php ENDPATH**/ ?>