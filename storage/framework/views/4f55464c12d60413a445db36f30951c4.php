<div class="w-full" x-data="window.CQjwMygsGRWknEn" x-init="initialize">
    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-7">
            <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-grey-100 dark:border-zinc-700 px-8 py-6">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/seller/gigs/options/steps/overview.blade.php ENDPATH**/ ?>