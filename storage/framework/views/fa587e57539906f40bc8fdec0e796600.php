...
} elseif ($_instance->childHasBeenRendered('NFder9q')) {
    $componentId = $_instance->getRenderedChildComponentId('NFder9q');
    $componentTag = $_instance->getRenderedChildComponentTagName('NFder9q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NFder9q');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $review->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('NFder9q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/account/reviews/options/edit.blade.php ENDPATH**/ ?>