...
} elseif ($_instance->childHasBeenRendered('0dIUsRW')) {
    $componentId = $_instance->getRenderedChildComponentId('0dIUsRW');
    $componentTag = $_instance->getRenderedChildComponentTagName('0dIUsRW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0dIUsRW');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('0dIUsRW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('6O5mJNA')) {
    $componentId = $_instance->getRenderedChildComponentId('6O5mJNA');
    $componentTag = $_instance->getRenderedChildComponentTagName('6O5mJNA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6O5mJNA');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('6O5mJNA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/sweetman/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>