...
} elseif ($_instance->childHasBeenRendered('l233458551-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l233458551-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l233458551-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l233458551-1');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('l233458551-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l233458551-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l233458551-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l233458551-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l233458551-2');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.pricing');
    $html = $response->html();
    $_instance->logRenderedChild('l233458551-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l233458551-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l233458551-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l233458551-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l233458551-3');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.requirements');
    $html = $response->html();
    $_instance->logRenderedChild('l233458551-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('l233458551-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l233458551-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l233458551-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l233458551-4');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.gallery');
    $html = $response->html();
    $_instance->logRenderedChild('l233458551-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/create/create.blade.php ENDPATH**/ ?>