<div class="w-full px-2 lg:px-0">
    <div class="w-full lg:max-w-4xl mx-auto">
        <div class="relative py-16 bg-white dark:bg-zinc-800 overflow-hidden rounded-md shadow-sm border border-gray-100 black:border-zinc-700">
...
</div><?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/page/page.blade.php ENDPATH**/ ?>