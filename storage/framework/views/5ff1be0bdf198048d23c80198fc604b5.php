...
} elseif ($_instance->childHasBeenRendered('7x4tlNd')) {
    $componentId = $_instance->getRenderedChildComponentId('7x4tlNd');
    $componentTag = $_instance->getRenderedChildComponentTagName('7x4tlNd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7x4tlNd');
} else {
    $response = \Livewire\Livewire::mount('main.partials.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7x4tlNd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="http://localhost/sweetman/wireui/assets/scripts?id=be97ebae74d62aa4c86689a6528b707f" defer ></script>
  ...
  <?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/seller/layout/app.blade.php ENDPATH**/ ?>