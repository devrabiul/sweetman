...
} elseif ($_instance->childHasBeenRendered('fx1ru7k')) {
    $componentId = $_instance->getRenderedChildComponentId('fx1ru7k');
    $componentTag = $_instance->getRenderedChildComponentTagName('fx1ru7k');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fx1ru7k');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('fx1ru7k', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <?php if(request()->is('/')): ?>
            ...
            <div class="home-hero-section">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
                   ...
                   <button type="submit" class="px-5 py-4 ltr:ml-2 rtl:mr-2 text-sm font-medium text-white bg-red-600 rounded-md border-none hover:bg-red-800 focus:ring-0 focus:outline-none">
...
} elseif ($_instance->childHasBeenRendered('pqiAnt0')) {
    $componentId = $_instance->getRenderedChildComponentId('pqiAnt0');
    $componentTag = $_instance->getRenderedChildComponentTagName('pqiAnt0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pqiAnt0');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('pqiAnt0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://daynightgamer.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>