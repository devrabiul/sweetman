                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            <?php if($gig->video_id): ?>
                                    ...
                                    data-splide-youtube="https://www.youtube.com/watch?v=<?php echo e($gig->video_id); ?>">
                                    <img src="<?php echo e(src($gig->imageLarge)); ?>" alt="<?php echo e($gig->title); ?>"
                                        class="object-contain" onclick="openModal('<?php echo e(src($gig->imageLarge)); ?>')">
                                </li>
                            <?php endif; ?>
                            <?php $__currentLoopData = $gig->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="splide__slide dark:bg-zinc-0 bg-gray-0 object-contain">
                                    <img src="<?php echo e(src($image->large)); ?>" alt="<?php echo e($gig->title); ?>"
                                        class="object-contain" onclick="openModal('<?php echo e(src($image->large)); ?>')">
                                </li>
...
<script>
    ...
    document.getElementById('image-modal').addEventListener('click', function (event) {
        const modalImage = document.getElementById('modal-image');
        if (event.target === this || event.target === modalImage) {
            closeModal();
        }
    });
</script>
    ...
    <?php if($related_gigs): ?>
        <div class="mt-12 sm:mt-24" wire:ignore>
            ...
            <div id="slick-related-gigs" class="-mx-20" wire:ignore>
        ...
        return {
            ...
            initMainCarousel() {
                var main = new Splide('#main-carousel', {
                    ...
                    rewind: true,
                    pagination: true,
                    arrows: false, // Main carousel arrows removed
                    video: {
                        loop: true,
                        mute: false
                    },
                ...
                var thumbnails = new Splide('#thumbnail-carousel', {
                    ...
                    pagination: false,
                    isNavigation: true,
                    arrows: false, // Arrows removed from thumbnail carousel
                    breakpoints: {
                        100: {
                            fixedWidth: 60,
                            fixedHeight: 44,
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/service/service.blade.php ENDPATH**/ ?>