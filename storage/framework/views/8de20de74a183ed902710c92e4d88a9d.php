...
} elseif ($_instance->childHasBeenRendered('l1968631069-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1968631069-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1968631069-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1968631069-0');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('l1968631069-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>