...
} elseif ($_instance->childHasBeenRendered('l2303583816-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2303583816-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2303583816-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2303583816-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l2303583816-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l2303583816-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l2303583816-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2303583816-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2303583816-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l2303583816-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l2303583816-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l2303583816-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2303583816-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2303583816-2');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l2303583816-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <div class="w-full h-px bg-grey-100 dark:bg-zinc-900 hidden md:block"></div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>