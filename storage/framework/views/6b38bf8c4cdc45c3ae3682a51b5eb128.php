...
<html lang="<?php echo e(app()->getLocale()); ?>" dir="<?php echo e(config()->get('direction')); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => current_theme() === 'dark']); ?>">
    ...
    <body class="antialiased bg-grey-50 dark:bg-[#161616] text-gray-600 min-h-full flex flex-col application application-ltr overflow-x-hidden <?php echo e(app()->getLocale() === 'ar' ? 'application-ar' : ''); ?>">
...
<?php endif; ?>
        ...
        <div class="min-h-screen flex grow bg-slate-50 dark:bg-zinc-700">
            ...
            <main class="flex w-full flex-col items-center bg-black
            white:bg-zinc-700 lg:max-w-md">
...
<script src="https://www.daynightgamer.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/auth/layout/auth.blade.php ENDPATH**/ ?>