...
} elseif ($_instance->childHasBeenRendered('PAwtjht')) {
    $componentId = $_instance->getRenderedChildComponentId('PAwtjht');
    $componentTag = $_instance->getRenderedChildComponentTagName('PAwtjht');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PAwtjht');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.overview', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('PAwtjht', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('21EbwVS')) {
    $componentId = $_instance->getRenderedChildComponentId('21EbwVS');
    $componentTag = $_instance->getRenderedChildComponentTagName('21EbwVS');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('21EbwVS');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.pricing', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('21EbwVS', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('oViQWcb')) {
    $componentId = $_instance->getRenderedChildComponentId('oViQWcb');
    $componentTag = $_instance->getRenderedChildComponentTagName('oViQWcb');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oViQWcb');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.requirements', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('oViQWcb', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('1x5YmIi')) {
    $componentId = $_instance->getRenderedChildComponentId('1x5YmIi');
    $componentTag = $_instance->getRenderedChildComponentTagName('1x5YmIi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1x5YmIi');
} else {
    $response = \Livewire\Livewire::mount('main.seller.gigs.options.steps.gallery', ['gig' => $gig]);
    $html = $response->html();
    $_instance->logRenderedChild('1x5YmIi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php endif; ?>
...
</div><?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/seller/gigs/options/edit.blade.php ENDPATH**/ ?>