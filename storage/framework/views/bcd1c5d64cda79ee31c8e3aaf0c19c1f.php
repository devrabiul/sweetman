<div class="w-full relative md:pt-16">
    ...
    <div class="bg-dark dark:bg-zinc-800 sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden shadow-sm border dark:border-zinc-700">
        <div class="">
...
<?php endif; ?>
        ...
        <div class="px-4 py-6 bg-grey-50 dark:bg-zinc-700 border-t-2 border-gray-200 dark:border-zinc-700 sm:px-6 text-center">
...
<?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/auth/request.blade.php ENDPATH**/ ?>