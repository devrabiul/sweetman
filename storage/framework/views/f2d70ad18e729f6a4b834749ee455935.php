...
} elseif ($_instance->childHasBeenRendered('KdPBeq1')) {
    $componentId = $_instance->getRenderedChildComponentId('KdPBeq1');
    $componentTag = $_instance->getRenderedChildComponentTagName('KdPBeq1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KdPBeq1');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('KdPBeq1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('HQSZHHK')) {
    $componentId = $_instance->getRenderedChildComponentId('HQSZHHK');
    $componentTag = $_instance->getRenderedChildComponentTagName('HQSZHHK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HQSZHHK');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('HQSZHHK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>