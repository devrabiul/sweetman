...
} elseif ($_instance->childHasBeenRendered('AKpNRQT')) {
    $componentId = $_instance->getRenderedChildComponentId('AKpNRQT');
    $componentTag = $_instance->getRenderedChildComponentTagName('AKpNRQT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AKpNRQT');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.overview');
    $html = $response->html();
    $_instance->logRenderedChild('AKpNRQT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('p9l9eMJ')) {
    $componentId = $_instance->getRenderedChildComponentId('p9l9eMJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('p9l9eMJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('p9l9eMJ');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.pricing');
    $html = $response->html();
    $_instance->logRenderedChild('p9l9eMJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('ZVPQz06')) {
    $componentId = $_instance->getRenderedChildComponentId('ZVPQz06');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZVPQz06');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZVPQz06');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.requirements');
    $html = $response->html();
    $_instance->logRenderedChild('ZVPQz06', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
} elseif ($_instance->childHasBeenRendered('LUtFtJP')) {
    $componentId = $_instance->getRenderedChildComponentId('LUtFtJP');
    $componentTag = $_instance->getRenderedChildComponentTagName('LUtFtJP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LUtFtJP');
} else {
    $response = \Livewire\Livewire::mount('main.create.steps.gallery');
    $html = $response->html();
    $_instance->logRenderedChild('LUtFtJP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/create/create.blade.php ENDPATH**/ ?>