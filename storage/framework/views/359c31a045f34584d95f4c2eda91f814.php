...
} elseif ($_instance->childHasBeenRendered('nxsoWsG')) {
    $componentId = $_instance->getRenderedChildComponentId('nxsoWsG');
    $componentTag = $_instance->getRenderedChildComponentTagName('nxsoWsG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nxsoWsG');
} else {
    $response = \Livewire\Livewire::mount('main.cards.gig', ['gig' => $item->gig]);
    $html = $response->html();
    $_instance->logRenderedChild('nxsoWsG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /opt/lampp/htdocs/sweetman/resources/views/livewire/main/account/reviews/options/create.blade.php ENDPATH**/ ?>