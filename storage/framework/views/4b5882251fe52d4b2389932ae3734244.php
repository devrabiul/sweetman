...
<div class="flex-shrink-0 mb-5 md:mb-0">
    <div class="inline-block relative">
        <img src="<?php echo e(placeholder_img()); ?>" 
             data-src="<?php echo e(src($user->avatar)); ?>" 
             alt="<?php echo e($user->username); ?>" 
             class="inline-block w-24 h-24 rounded-full border-2 border-gray-300 shadow-md object-cover lazy transition-transform transform hover:scale-105">
    </div>
</div>
                            ...
                            <div class="flex items-center space-x-2 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0 flex-col md:flex-row">
                                ...
                                <?php if($user->level): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border px-3 py-1 text-xs font-normal tracking-wide" style="color: <?php echo e($user->level->level_color); ?>;border-color: <?php echo e($user->level->level_color); ?>;">
                                        <span class="whitespace-nowrap"><?php echo e($user->level->title); ?></span>
                                    </span>
                                <?php endif; ?>
...
<?php endif; ?>
                    ...
                    <div class="w-9 h-9">
                        <button type="button" id="modal-share-profile-button" data-tooltip-target="tooltip-profile-page-share-user" class="text-zinc-400 hover:text-zinc-500 bg-white hover:bg-gray-100 border border-gray-200 cursor-pointer rounded focus:outline-none h-9 w-9 flex items-center justify-center black:border-zinc-700 dark:bg-zinc-700/40 dark:text-zinc-400 dark:hover:bg-zinc-800">
...
<?php if($user->account_type === 'seller' && $last_delivery): ?>
    <li class="bg-white shadow-md rounded-lg p-4 flex items-center space-x-3">
        <div class="flex items-center">
            <svg class="h-6 w-6 text-red-600 transition-transform transform hover:scale-105" stroke="currentColor" fill="currentColor" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex justify-between w-full">
            <span class="text-gray-700 font-semibold text-sm"><?php echo app('translator')->get('messages.t_last_delivery'); ?></span>
            <span class="text-gray-600 text-sm">1 week ago</span>
        </div>
    </li>
<?php endif; ?>
...
<li class="bg-white shadow-md rounded-lg p-4 flex items-center space-x-3">
    ...
    <span class="text-gray-700 font-semibold text-sm"><?php echo app('translator')->get('messages.t_member_since'); ?> <?php echo e(format_date($user->created_at, config('carbon-formats.F_j,_Y'))); ?></span>
</li>
...
<?php if($user->account_type === 'seller' && $user_rating['total'] > 0): ?>
    <section class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        ...
        <div class="mb-5">
            <h1 class="text-2xl font-bold text-zinc-800 dark:text-zinc-100">Reviews</h1>
        </div>



<div class="flex flex-col items-center gap-8 p-6 bg-transparent rounded-lg shadow-lg">
    
    <div class="flex items-center gap-2">
        <?php echo render_star_rating($user_rating['value'], "1rem", "1rem", "#d0d0d0"); ?>

        <span class="text-xl font-bold text-amber-500">
            <?php echo e($user_rating['value']); ?>/5
        </span>
    </div>
</div>
...
<?php if($user_rating['total'] > 1): ?>
    <span class="text-md text-slate-400">Based on <?php echo e($user_rating['total']); ?> reviews</span>
<?php endif; ?>
            ...
            <div class="flex flex-col w-full gap-4">
                <?php $__currentLoopData = [5, 4, 3, 2, 1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center w-full">
                        <label class="flex-none w-16 text-md text-slate-500 dark:text-zinc-400"><?php echo e($star); ?> stars</label>
                        <div class="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden">
                            <div class="bg-red-500 h-full" style="width: <?php echo e($user_rating['stars_'.$star] * 100 / $user_rating['total']); ?>%;"></div>
                        </div>
                        <span class="flex-none w-12 text-md font-bold text-slate-700 dark:text-zinc-300"><?php echo e($user_rating['stars_'.$star]); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 col-span-2 py-6 divide-y dark:divide-zinc-700 space-y-8">
                ...
                <?php if($gigs && $gigs->count()): ?>
                    <section class="px-7 pt-8">
                        ...
                        <div class="mb-5">
                            <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100"><?php echo app('translator')->get('recent offers'); ?></h1>
                        </div>
                            ...
                            <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex flex-col overflow-hidden [&:not(:first-child)]:pt-4 lg:[&:not(:first-child)]:pt-8" wire:key="profile-gigs-<?php echo e($gig->uid); ?>">
                                    <div class="flex flex-col grow md:flex-row md:space-x-6 md:space-y-0 rtl:space-x-reverse space-y-4 w-full">
                                         ...
                                         <a href="<?php echo e(url('service', $gig->slug)); ?>" class="flex-none md:w-32 h-min rounded-lg overflow-hidden relative">
    <img src="<?php echo e(placeholder_img()); ?>" data-src="<?php echo e(src($gig->thumbnail)); ?>" alt="<?php echo e($gig->title); ?>" class="rounded-lg object-cover w-full h-full transition duration-500 lazy">
</a>
                                        ...
                                        <div class="flex-none md:w-48 space-y-4 md:ltr:pr-1 md:rtl:pl-1">
                                            ...
                                            <div class="bg-grey-100 flex flex-col items-center justify-center p-3 rounded-lg dark:bg-zinc-700">
                    ...
                    <div class="mt-4 sm:mt-6 w-full">
                        <div class="bg-slate-100 rounded p-3 dark:bg-zinc-700">
                            <div tabindex="0" aria-label="copy link" class="focus:outline-none flex items-center justify-between">
                                ...
                                <p class="ltr:border-l rtl:border-r border-slate-300 cursor-pointer font-semibold leading-3 ltr:pl-3 rtl:pr-3 text-slate-600 text-xs black:border-zinc-600 dark:text-zinc-300 dark:hover:text-white hover:text-black" x-on:click="copyProfileLink()">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/u846460818/domains/daynightgamer.com/public_html/resources/views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>